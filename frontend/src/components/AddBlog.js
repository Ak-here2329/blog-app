    ...
    <div>
      <form onSubmit={handleSubmit}>
        <Box 
          ...
          width={'80%'}
          >
          <Typography  fontWeight={'bold'} padding={3} color="#aaa" variant="h2" textAlign={"center"}>Post Your Blog</Typography>
          ...
          <TextField  margin='normal' variant='outlined' value={inputs.imageURL} name="imageURL" onChange={handleChange}/>
          <Button 
